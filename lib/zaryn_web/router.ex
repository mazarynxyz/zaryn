defmodule ZarynWeb.Router do
  ...
  pipeline :api_authenticated do
    plug ZarynWeb.AuthAccessPipeline
  end

  pipeline :graphql do
    plug ZarynWeb.Context
  end

  scope "/api" do
    pipe_through :graphql

    forward "/", Absinthe.Plug, schema: ZarynWeb.Schema
  end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: ZarynWeb.Telemetry, ecto_repos: [Zaryn.Repo]
    end
  end
  ...
  if Mix.env == :dev do
    forward "/graphiql", Absinthe.Plug.GraphiQL, schema: ZarynWeb.Schema
  end
end
